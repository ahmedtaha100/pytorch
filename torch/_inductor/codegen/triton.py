...
class TritonKernel(SIMDKernel[TritonCSEVariable]):
    ...
    def _reduction_invariant_indexing_shape(
        ...
        # A non-combo kernel with a zero pointwise extent has an empty launch
        # grid. A combo grid can still launch this subkernel because a sibling
        # has more blocks, so require one valid pointwise coordinate here.
